const CACHE='simplepos-v13';
const ASSETS=['/','/index.html','/app-v2.js','/local-first.js','/local-cache-fallback.js','/bridge-ui.js','/business-suite.js','/fixed-expenses.js','/payment-hook.js','/mev-runtime.js','/ui-shell.js','/pivots.js','/styles.css','/business-suite.css','/config.js','/manifest.webmanifest'];
