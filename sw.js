const CACHE='simplepos-v7';
const ASSETS=['/','/index.html','/app-v2.js','/local-first.js','/bridge-ui.js','/payment-hook.js','/floorplan.js','/mev-runtime.js','/styles.css','/terminal.css','/floorplan.css','/config.js','/manifest.webmanifest'];
