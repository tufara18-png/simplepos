const CACHE='simplepos-v9';
const ASSETS=['/','/index.html','/app-v2.js','/local-first.js','/local-cache-fallback.js','/bridge-ui.js','/business-suite.js','/payment-hook.js','/floorplan.js','/mev-runtime.js','/styles.css','/terminal.css','/floorplan.css','/business-suite.css','/config.js','/manifest.webmanifest'];
